...
import (
	...
	pbc "exam_task_4/post-service-project/genproto/comment-service"
	pbp "exam_task_4/post-service-project/genproto/post-service"
	pbu "exam_task_4/post-service-project/genproto/user-service"
	mock "exam_task_4/post-service-project/mock_data"
	"fmt"
...
type IServiceManager interface {
	...
	MockService() mock.MockServiceClientP
}
...
func New(cfg config.Config) (IServiceManager, error) {
	...
	return &serviceManager{
		...
		mockService: mock.NewMockServiceClientP(),
	}, nil
}
...
func (s *serviceManager) MockService() mock.MockServiceClientP {
